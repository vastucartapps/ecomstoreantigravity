        ...
        headers: [
          ...
          // 'unsafe-inline' on styles is required by Tailwind CSS inline styles.
          {
            ...
            value: [
              ...
              "connect-src 'self' https://sapi.vastucart.in https://store.vastucart.in https://api.razorpay.com https://lumberjack.razorpay.com https://api.stripe.com https://app.posthog.com https://www.google-analytics.com wss:",
