...
import { syncMetaProductsStep } from "./steps/sync-meta-products"

type SyncMetaWorkflowInput = {
  filters?: Record<string, unknown>
  limit?: number
  offset?: number
}

export const syncMetaProductsWorkflow = createWorkflow(
  "sync-meta-products",
  ({ filters, limit, offset }: SyncMetaWorkflowInput) => {
    ...
    syncMetaProductsStep({ products: publishedProducts as any })
